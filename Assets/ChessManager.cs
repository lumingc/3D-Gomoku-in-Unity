...
public class ChessManager : MonoBehaviour
{
    ...
    private PlaceGameBoards placeGameBoards;
    ...
    void Start()
    {
        ...
        placeGameBoards = GetComponent<PlaceGameBoards>();
    }

    // Update is called once per frame
    void Update()
    {
       if (placeGameBoards.Placed() && Input.touchCount > 0)
        {
            ...
            if (Physics.Raycast(ray, out hit, 100))
            {
                ...
                if(hit.transform.tag=="Interactable")
                    ...
                    hit.transform.GetComponent<Chess>().OnTouch(placeGameBoards);
            }
        } 
    }
}
